            ...
            <div class="card-body">
                ...
                <div class="img-fluid text-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="exampleInputName1" placeholder="Package Name" required>
                        <span class="text-danger"><?php echo $nameErr; ?></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Amount</label>
                        <input type="text" name="amount" value="<?php echo $amount; ?>" class="form-control" id="exampleInputEmail3" placeholder="Amount" required>
